...
class PagingChatDataObserverI(adapter: PagingChatAdapter?) :PagingChatDataObserver(adapter) {
...
abstract class PagingChatDataObserver(val adapter: PagingChatAdapter?) : RecyclerView.AdapterDataObserver() {
