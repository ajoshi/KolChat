...
class RoomInserter {
    fun insertMessage(serverMessage: ServerChatMessage) {
        val dbMessage = ChatMessage(0, serverMessage.author.id, serverMessage.author.id, serverMessage.htmlText, serverMessage.channelNameServer.id, serverMessage.time)
